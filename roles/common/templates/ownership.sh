...
print_help() {
cat <<-HELP
This script is used to fix the file and directory ownership of a Drupal project.
...
echo "Setting ownership and permissions for Drupal installation at $ROOT"
chown -R $SCRIPT_USER:$WEB_GROUP $ROOT
find $ROOT -type d -exec chmod 770 {} \;
find $ROOT -type f -exec chmod 660 {} \;

echo "Ownership and permissions have been set successfully."
